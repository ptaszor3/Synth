...
namespace effects {
	Sample UnsynchronizedTremolo::callback(Note note, Instrument *instrument, DoubleSeconds duration_from_start, int effects_position) { 
		Sample sample_to_change = instrument->callback_single_sample_effect_prior_to(note, duration_from_start, effects_position); 
